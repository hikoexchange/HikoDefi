...
const defaultToolsAndFooterLinks = {
	...
	footer: [
		{ name: 'About HikoDefi', path: '/about' },
		{
			name: 'Twitter',
			path: 'https://twitter.com/hikoexchange',
			external: true
		},
		{
			name: 'Telegram',
			path: 'https://t.me/hikoexchange',
			external: true
		},
...
export const navLinks: ILinks = {
	...
	Yields: {
		...
		tools: [
			...
			{ name: 'List your protocol', path: 'https://github.com/HikoDefi/yield-server#readme', external: true },
			{
				name: 'Download Data',
		...
		footer: [
			...
			{
				name: 'Twitter',
				path: 'https://twitter.com/HikoDefi',
				external: true
			},
			{
				name: 'Discord',
