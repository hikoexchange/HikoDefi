...
const SEO = ({
	...
	return (
		<Head>
			<meta
				name="description"
				content="HikoDefi is a DeFi TVL aggregator. It is committed to providing accurate data without ads or sponsored content, as well as transparency."
			/>

			<meta property="og:title" content="HikoDefi" />
			<meta property="og:type" content="website" />
			<meta property="og:url" content={windowURL} />
			<meta property="og:site_name" content="HikoDefi" />
			<meta
			...
			<meta name="twitter:title" content="HikoDefi" />
			<meta name="twitter:site" content="@HikoDefi" />
			<meta name="twitter:creator" content="@HikoDefi" />
			<meta
