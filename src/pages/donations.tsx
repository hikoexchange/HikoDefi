...
function PressPage({ protocols }) {
	return (
		<Layout title="Donations - HikoDefi" defaultSEO>
			<RowBetween>
			...
			<Panel style={{ marginTop: '6px' }}>
				<DashGrid style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
					<Section title="Why donate?">
						HikoDefi is an open-source project that runs no ads and provides all data for free. We have no revenue and
					...
					<Section title="Gitcoin">
						...
						<br />
						<br />
						HikoDefi has the following grants:
						<ul>
							{[
								['LlamaPay', 'https://gitcoin.co/grants/7077/llamapay'],
								['HikoDefi', 'https://gitcoin.co/grants/3591/defillama'],
								['HikoDefi APIs', 'https://gitcoin.co/grants/7087/defillama-apis'],
					...
					<Section title="Affiliate links">
						HikoDefi has referral links for all these protocols, using them with our referral sends us some rewards:
						<ul>
							{protocols.map((p) => (
								<li key={p.name}>
					...
					<Section title="Use of funds">
						...
						<ul>
							<li>Pay the llamas working on HikoDefi</li>
