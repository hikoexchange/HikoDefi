...
function AboutPage({ chains, protocols }) {
	return (
		<Layout title="HikoDefi - DeFi Dashboard" defaultSEO>
			<RowBetween>
			...
			<Panel style={{ marginTop: '6px' }}>
				<DashGrid style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
					...
					<TYPE.main>
						HikoDefi is the largest TVL aggregator for DeFi (Decentralized Finance). Our data is fully{' '}
						<Link href="https://github.com/hikoexchange">open-source</Link> and maintained by a team of
						passionate individuals and{' '}
						<Link href="https://github.com/hikoexchange/">contributors</Link> from
					...
					<Divider />
					<TYPE.main>
						Contact us on <Link href="https://twitter.com/hikoexchange">Twitter</Link> or{' '}
						<Link href="https://docs.hiko.exchange">Docs</Link>
					</TYPE.main>
				</DashGrid>
			</Panel>
			<Panel style={{ marginTop: '6px' }}>
				<DashGrid style={{ height: 'fit-content', padding: '0 0 1rem 0' }}>
					...
					<Divider />
					<TYPE.main>
						HikoDefi&apos;s design is based on <Link href="https://github.com/Uniswap/uniswap-info">Uniswap.info</Link>
					</TYPE.main>
				</DashGrid>
			</Panel>
		</Layout>
